...
def GetDatesWorked():
    fromdate = input("Enter a start daate (mm/dd/yyyy):  ")
...
def printinfo(DetailsPrinted):
    ...
    TotTax = 0.00
    TotNetPay = 0.00
    EmpFile = open("Employess.txt", "r")
    while True:
        rundate = input("Enter start date for report (mm/dd/yyyyy) or ALL for data in file: ")
...
def PrintTotals(EmpTotals):
    print()
    print(f"Total numbr of employees: {EmpTotals['TotEmp']}")
